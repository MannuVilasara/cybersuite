        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              A unified cybersecurity platform designed for developers, startups, and enterprises that 
              consolidates multiple security tools into one comprehensive solution.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div className="bg-black/40 backdrop-blur-xl rounded-3xl p-8 border border-white/10">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                Developers juggle multiple security tools - separate solutions for code scanning, secrets management, 
                vulnerability tracking, and compliance monitoring. This fragmentation leads to:
              </p>
            ...
            <div className="bg-black/40 backdrop-blur-xl rounded-3xl p-8 border border-white/10">
              ...
              <ul className="space-y-2 text-gray-400">
                <li>• <span className="text-green-400">All-in-one</span> security dashboard</li>
                <li>• <span className="text-blue-400">AI-powered</span> vulnerability analysis</li>
                <li>• <span className="text-purple-400">Zero-trust</span> secrets vault</li>
                <li>• <span className="text-red-400">Real-time</span> threat monitoring</li>
              </ul>
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="bg-black/40 backdrop-blur-xl rounded-3xl p-8 border border-white/10 mb-8">
              ...
              <div className="border-t border-white/10 pt-8">
                <h4 className="text-lg font-bold text-white mb-6 text-center">Microservices Architecture</h4>
          ...
          <div className="text-center bg-black/40 backdrop-blur-xl rounded-3xl p-12 border border-white/10">
            ...
            <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
              Join thousands of developers who trust SecureAuth to protect their code, secure their secrets, 
              and maintain compliance with enterprise-grade security tools.
            </p>
