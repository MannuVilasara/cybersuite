              ...
              >
                  ...
                  <form onSubmit={sendOtpHandler} className="space-y-5">
                    ...
                    <div className="flex items-start gap-3 mt-4">
                      ...
                      <label htmlFor="acceptTermsSignup" className="text-gray-300 text-sm cursor-pointer">
                        I agree to the{" "}
                        <Link href="/terms-and-conditions"  className="text-white hover:text-gray-300 underline">
                ...
                <div className="text-center mt-6 pt-6 border-t border-gray-700/30">
                  <p className="text-gray-400 text-sm">
                    ...
                    <Link href="/login" className="text-white hover:text-gray-300 font-medium transition-colors duration-300">
                      Login
                    </Link>
                  </p>
                </div>
